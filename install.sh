...
#    curl -sL https://${GITHUB_RAW_URL}/install.sh -o /tmp/nezha.sh
    curl -sL https://github.com/qiuxiuya/Nezha-v0/raw/refs/heads/main/install.sh -o /tmp/nezha-v0.sh
...
#        NZ_AGENT_URL="https://${GITHUB_URL}/naibahq/agent/releases/download/${_version}/nezha-agent_linux_${os_arch}.zip"
        NZ_AGENT_URL="https://${GITHUB_URL}/qiuxiuya/Nezha-v0/raw/refs/heads/main/Down/nezha-agent_linux_${os_arch}.zip"
    fi
...
#            _download="sudo wget -t 2 -T 60 -O $NZ_DASHBOARD_SERVICE https://${GITHUB_RAW_URL}/services/nezha-dashboard.service >/dev/null 2>&1"
            _download="sudo wget -t 2 -T 60 -O $NZ_DASHBOARD_SERVICE https://github.com/qiuxiuya/Nezha-v0/raw/refs/heads/main/nezha-dashboard.service >/dev/null 2>&1"
...
#            _download="sudo wget -t 2 -T 60 -O $NZ_DASHBOARD_SERVICERC https://${GITHUB_RAW_URL}/services/nezha-dashboard >/dev/null 2>&1"
            _download="sudo wget -t 2 -T 60 -O $NZ_DASHBOARD_SERVICERC https://github.com/qiuxiuya/Nezha-v0/raw/refs/heads/main/nezha-dashboard >/dev/null 2>&1"
            if ! eval "$_download"; then
                err "文件下载失败，请检查本机能否连接 ${GITHUB_RAW_URL}"
                return 0
            fi
...
#        NZ_DASHBOARD_URL="https://${GITHUB_URL}/naiba/nezha/releases/download/${_version}/dashboard-linux-${os_arch}.zip"
        NZ_DASHBOARD_URL="https://${GITHUB_URL}/qiuxiuya/Nezha-v0/raw/refs/heads/main/Down/dashboard-linux-${os_arch}.7z"
    else
        NZ_DASHBOARD_URL="https://${GITHUB_URL}/qiuxiuya/Nezha-v0/raw/refs/heads/main/Down/dashboard-linux-${os_arch}.7z"
    fi
...
show_menu() {
    ...
    --- https://github.com/qiuxiuya/Nezha-v0 ---
    ${green}1.${plain}  安装面板端
